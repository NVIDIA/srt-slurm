...
def run_metrics(args, run_dir: Path, bundle: Path) -> bool:
    ...
    if args.metrics == "aiperf-json":
        ...
        patterns = [args.aiperf_server_metrics] if args.aiperf_server_metrics else [
...
def build_parser() -> argparse.ArgumentParser:
    ...
    # metrics axis
    p.add_argument("--metrics", choices=["prometheus", "aiperf-json", "none"], default="prometheus")
