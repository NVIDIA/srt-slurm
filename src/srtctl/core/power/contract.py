...
MEASUREMENT_WINDOW_BENCHMARK_TYPE_ENV = "SRT_MEASUREMENT_WINDOW_BENCHMARK_TYPE"
MEASUREMENT_WINDOW_CONCURRENCIES_ENV = "SRT_MEASUREMENT_WINDOW_CONCURRENCIES"
MEASUREMENT_WINDOW_RESULT_ROOT_ENV = "SRT_MEASUREMENT_WINDOW_RESULT_ROOT"
