...
class SGLangProtocol:
    ...
    def build_worker_command(
        ...
        Args:
            ...
            frontend_type: Frontend type - "sglang"/"sgl-router" use
                sglang.launch_server, while "dynamo" uses dynamo.sglang
        ...
        if dump_config_path and frontend_type not in {"sglang", "sgl-router"}:
