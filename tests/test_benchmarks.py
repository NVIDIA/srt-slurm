...
class TestRunPostEval:
    ...
    def _make_orchestrator():
        ...
        from srtctl.core.schema import BenchmarkConfig, FrontendConfig, HealthCheckConfig, ModelConfig, ResourceConfig, SrtConfig
    ...
    def test_eval_only_waits_for_full_health_check(self):
        ...
        with patch.dict(os.environ, {"EVAL_ONLY": "true", "EVAL_CONC": "128"}, clear=False):
            with patch("srtctl.core.health.wait_for_model", return_value=True) as mock_wait:
