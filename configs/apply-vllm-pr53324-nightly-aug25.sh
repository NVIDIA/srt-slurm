...
readonly K3_CHECKPOINT_INDEX_INT64_PATCH_FILE="${VLLM_K3_CHECKPOINT_INDEX_INT64_PATCH_FILE:-/configs/patches/vllm-k3-prefill-checkpoint-index-int64-on-a9a17e7.patch}"
readonly PR51392_PATCH_FILE="${VLLM_PR51392_PATCH_FILE:-/configs/patches/vllm-pr51392-online-quant-prequantized-on-a9a17e7.patch}"
readonly K3_DCP_META_DEVICE_PATCH_FILE="${VLLM_K3_DCP_META_DEVICE_PATCH_FILE:-/configs/patches/vllm-k3-dcp-device-under-meta.patch}"
...
readonly K3_CHECKPOINT_INDEX_INT64_MARKER_FILE="${VLLM_ROOT}/.k3_prefill_checkpoint_index_int64_on_a9a17e709"
readonly PR51392_MARKER_FILE="${VLLM_ROOT}/.pr51392_online_quant_prequantized_on_a9a17e709"
readonly K3_DCP_META_DEVICE_MARKER_FILE="${VLLM_ROOT}/.k3_dcp_device_under_meta_on_a9a17e709"
